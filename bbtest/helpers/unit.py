...
class UnitHelper(object):
  ...
  def install(self, file):
    ...
    if code != 'OK':
      ...
      with open('{}/reports/blackbox-tests/meta/debian.fio-bco.txt'.format(cwd), 'w') as fd:
        fd.write(result)
  ...
  def download(self):
    ...
    self.binary = '{}/packaging/bin/fio-bco_{}_{}.deb'.format(cwd, self.debian_version, self.arch)
    ...
    image = 'docker.io/openbank/fio-bco:{}'.format(self.image_version)
